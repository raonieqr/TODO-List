(() => {
  ...
  class e {
    ...
    static getStorage(e) { return localStorage.getItem(e) }
    ...
    static storeTask(e) {
      ...
      e.id = t, n.push(e), localStorage.setItem("taskArray", JSON.stringify(n)),
  ...
  function t(e) { return /^\d{2}\/\d{2}\/\d{4} \d{2}:\d{2}$/.test(e) }
  function n(e) {
    const [t, n] = e.split(" "), [ o, l, i ] = t.split("/"),
              [ a, r ] = n.split(":"), d = parseInt(l, 10), s = parseInt(a, 10),
              c = parseInt(r, 10),
              u = new Date(i, d - 1, o, s, c).getTime() - Date.now();
    return function(e) { return e > 12 }(d) || function(e, t) {
      return e > 23 || t > 59
    }(s, c) || function(e, t) {
      return 2 === e && t > 29 || [ 4, 6, 9, 11 ].includes(e) && t > 30 ||
             t > 31
    }(d, o) || function(e) { return e < 0 }(u) ? 0 : 1
  }
  function o(e) { return [ "todo", "doing", "done" ].includes(e) }
  function l(e) { return /^[1-5]$/.test(e) }
  document.addEventListener(
      "DOMContentLoaded", (function() {
        ...
        let c = document.getElementById("addTask"),
            u = e.getStorage("taskArray"), y = u ? JSON.parse(u) : [];
                ...
                "click", (function(i) {
                  ...
                  let a = function() {
                    const i =
                          ...
                          a = {};
                    for (const e of i)
                      if (a[e] = document.getElementById(e).value,
                          "" === a[e].trim())
                        return alert(
                               ...
                               ? l(a.priority)
                                     ? t(a.dateTime) && n(a.dateTime)
                                           ...
                                           : (alert(`Error: data ${
                                              ...
                                              null)
                                     : (alert(
                                            "Error: Prioridade inválida. Use um número de 1 a 5."),
                                        null)
                               : (alert(
                                      "Error: Status inválido. Permitidos: todo, doing ou done."),
                                  null)
                  }();
                  a && (alert(`Tarefa ${a.name} foi criada`), y.push(a), s = !0,
        ...
        function g(t, n) {
          1 === y.length ? (y.pop(), d.style.display = "none") : y.splice(t, 1),
              e.storeUpdate("taskArray", y), n.parentNode.removeChild(n),
              0 === document.querySelectorAll('input[type="checkbox"]:checked')
                          .length &&
        ...
        function f(e) {
          return function(e) {
            ...
            E('<input type="checkbox" />'), E(e.id), E(e.name),
            E(e.description), E(e.category), E(e.priority), E(e.status),
            E(e.dateTime),
            E('<i id="pencil" class="ph ph-pencil-line"></i><i id="trash" class="ph ph-trash"></i>')
          ])
        }
        m.addEventListener(
            "click", (function() {
              y.length <= 0
                  ? alert("Lista vazia")
                  : (h.style.display = "inline-block", m.style.display = "none",
                     a.style.display = "none", p.style.display = "block",
                     p.scrollIntoView({behavior : "smooth"}), v())
            }));
        var k = 0;
        function v() {
          ...
          for (let n = 0; n < y.length; n++) {
            let o = y[n], l = f(o);
            t.appendChild(l), p.appendChild(e), p.appendChild(t),
                l.querySelector("#trash").addEventListener(
                    "click", (function() { g(n, l) })),
                l.querySelector("#pencil").addEventListener(
                    "click", (function() { k = n, B(o) }))
          }
          var o;
          (o = document.querySelectorAll('input[type="checkbox"]'))
              .forEach((function(e) {
        ...
        function I() {
          let e =
              Array.from(document.querySelectorAll("#tasks tbody tr"))
                  .filter(
                      (e => e.querySelector('input[type="checkbox"]').checked));
          return selectedRowsArray = e.map(
                     (e => Number(
                          e.querySelector("td:nth-child(2)").textContent))),
                 selectedRowsArray
        }
        function S() {
          let e = document.getElementById("editPageTask");
          "block" === e.style.display
              ? (h.style.display = "block", p.classList.remove("modalBlur"),
        ...
        function B(e) {
          ...
          t.value = e.name, n.value = e.description, o.value = e.category,
          l.value = e.priority, i.value = e.status, a.value = e.dateTime
        }
        function L() {
        ...
        function T() {
          ...
          "block" === e.style.display
              ? (p.classList.remove("modalBlur"), e.style.display = "none",
                 h.style.display = "block",
                 document.querySelectorAll('input[type="checkbox"]')
                     .forEach((e => e.checked = !1)),
                 L())
              : (e.style.display = "block", p.classList.add("modalBlur"),
                 d.style.display = "none", h.style.display = "none")
        }
        function b() {
          m.style.display = "none", a.style.display = "none",
          h.style.display = "inline-block", p.style.display = "block",
          p.scrollIntoView({behavior : "smooth"}), v(),
          m.removeEventListener("click", b)
        }
        d.addEventListener("click", (function() { T() })),
            document.getElementById("btnStatusTask")
                .addEventListener(
                    "click", (function() {
                      ...
                      if (n = I(), t.length > 0) {
                        for (var o = t[0].value; 0 !== n.length;) {
                          let e = n.pop();
                          y.forEach((t => {t.id === e && (t.status = o)}))
                        }
                        e.storeUpdate("taskArray", y), v(),
                            alert("Status modificado!"), T()
                      } else
                        alert("Error: selecione uma opção")
                    })),
            btnEditTask.addEventListener(
                "click", (() => {
                  !function(i) {
                    const a = function() {
                      ...
                      return {
                        name: e.value, description: t.value, category: n.value,
                            priority: o.value, status: l.value,
                            dateTime: i.value
                      }
                    }();
                    var r;
            ...
            document.getElementById("closeModalStatus")
                .addEventListener("click", (function() { T(), L() })),
